...
function(DownloadCEF platform channel version download_dir)
  ...
  if(NOT IS_DIRECTORY "${CEF_ROOT}")
	...
	file(COPY "${CEF_DOWNLOAD_DIR}/${CEF_DISTRIBUTION}/Debug" DESTINATION "${CMAKE_BINARY_DIR}/cef")
	file(COPY "${CEF_DOWNLOAD_DIR}/${CEF_DISTRIBUTION}/Resources/" DESTINATION "${CMAKE_BINARY_DIR}/")
	link_directories("${CMAKE_BINARY_DIR}/cef/Debug")
	include_directories("${CEF_DOWNLOAD_DIR}/${CEF_DISTRIBUTION}/include")
	include_directories("${CEF_DOWNLOAD_DIR}/${CEF_DISTRIBUTION}/")
endfunction()
