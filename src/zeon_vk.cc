...
void z::Zeon::SetupVulkan(ImVector<const char *> instance_extensions) {
  VkResult err;
...
void z::Zeon::SetupVulkanWindow(ImGui_ImplVulkanH_Window *wd,
...
void z::Zeon::CleanupVulkanWindow() {
  ImGui_ImplVulkanH_DestroyWindow(g_Instance, g_Device, &g_MainWindowData,
                                  g_Allocator);
}

void z::Zeon::FrameRender(ImGui_ImplVulkanH_Window *wd, ImDrawData *draw_data) {
...
void z::Zeon::FramePresent(ImGui_ImplVulkanH_Window *wd) {
